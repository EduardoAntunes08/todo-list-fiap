...
```
app/src/main/java/br/com/fiap/todolist/
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/EduardoAntunes08/todo-list-fiap.git
   ```
...
Eduardo Camilo — desenvolvido acompanhando, etapa por etapa, o projeto base de Ewerton Carreira ([carreiras/to-do-list](https://github.com/carreiras/to-do-list)).
