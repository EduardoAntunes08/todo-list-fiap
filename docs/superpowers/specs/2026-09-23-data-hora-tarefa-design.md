...
**Data:** 2026-09-23
**Contexto:** Evolução do app de lista de tarefas (ver [`2026-09-23-todo-list-design.md`](2026-09-23-todo-list-design.md)) — projeto pedagógico para alunos de 3º ano de Sistemas de Informação (FIAP).
